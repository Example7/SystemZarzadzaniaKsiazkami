...
namespace PracownikApp.Controllers
{
    ...
    {
        public KategoriaController(AppData.Data.AppContext context) : base(context) { }

        // GET: Kategoria
        public async Task<IActionResult> Index(string? searchTerm)
        {
            var query = _context.Kategoria.AsQueryable();

            query = ApplySearch(query, searchTerm, k => k.Nazwa);
